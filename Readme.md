...
- basic-testing — Basic testing exercises and examples (unit/integration tests).
- battleship — Battleship game implementation (game logic and UI/CLI).
- crud-api — RESTful CRUD API project demonstrating create/read/update/delete endpoints.
- file-manager — File manager application (file operations, CLI or HTTP interface).
- nodejs-basics — Node.js fundamentals and small exercises.
- task-graphql — GraphQL API task and schema/resolvers examples.
